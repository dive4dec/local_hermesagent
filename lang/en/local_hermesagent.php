...
$string['dashboard_port'] = 'Dashboard port';
$string['dashboard_port_desc'] = 'Local port for the Hermes web dashboard. Change if 9119 is already in use. Restart the dashboard by saving changes and reopening it.';
